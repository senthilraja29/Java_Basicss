...
public class A_136_Testng_amazon_login_excel_wrongdata 
{	
	String User;
	String Pass;
	@BeforeTest
	public void data_excel() throws EncryptedDocumentException, IOException
	{
		...
		Sheet excel = w_book_01.getSheet("amazon"); //right sheet name is amazon_login
		
		Row r1 = excel.getRow(1);
		Cell c1 = r1.getCell(0);
		User = c1.toString();
		
		Row r2 = excel.getRow(1);
